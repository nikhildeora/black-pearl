    ...
    <div>
      <div className={styles.main}>
        <div className={styles.div1}>
          <img
            src="https://cdn.caratlane.com/media/catalog/product/J/L/JL04330-YGP9P0_1_lar.jpg"
            alt=""
          />
        </div>
        <div className={styles.div2}>
          ...
          <div className={styles.productdes}>
            <p>
              Set in 18 KT Yellow Gold(4.440 g) with diamonds (0.090 ct ,IJ-SI)
            </p>
          </div>
          <br />
          ...
          <br />
          <div className={styles.spotlight}>SPOTLIGHTS</div>
          <br />
          ...
          <div className={styles.notify}>
            <p>
              Upon Price Drop,{" "}
              <span style={{ color: "#de57e5", cursor: "pointer" }}>
                {" "}
                Notify Me
              </span>
            </p>
