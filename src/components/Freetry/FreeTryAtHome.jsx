  ...
  return (
    <div className={styles.main__container}>
      <div className={styles.video__container}>
        <video className={styles.video__dex} autoPlay loop playsInline muted>
          <source
            src="https://assets.cltstatic.com/images/responsive/TAH-Desktop-Snippet.mp4"
            type="video/mp4"
          />
        </video>
        <video className={styles.video__mob}  autoPlay loop playsInline muted>
          <source
      ...
      <div className={styles.bestseller}>
        ...
        <div className={styles.input__box}>
          <div className={styles.input__wrapper2}>
            ...
            <label htmlFor="" className={styles.input__wrapper2__label}>
              Enter Pincode
            </label>
            <input
              spellCheck="false"
              className={styles.input__wrapper2__input}
              name="pincode"
              placeholder="PINCODE"
              id="pincode"
      ...
      >
        ...
        <SwiperSlide>
          ...
          <p className={styles.desc}>
            Try at home service very useful for people like us. Thanks for the
            excellent service by <br />
            the executive. Very polite person, had good knowledge about the
            product I will
        ...
        <SwiperSlide>
          ...
          <p className={styles.desc}>
            It was great experience of try at home. It saves time. Products were
            also good.
        ...
        <div className={styles.questions}>
          ...
          <div className={styles.contact}>
            ...
            <div className={styles.contact_call}>
              ...
              <a href="+91-44-42935000" className={styles.a_href}>
                +91-44-42935000
              </a>
            </div>
          </div>
        ...
        <div className={styles.Accordian_options}>
          <Accordion allowToggle>
            ...
            <AccordionItem className={styles.AccordianBtn}>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                Try at Home service is currently available in Agra, Ahmedabad,
                Bangalore, Bhubaneswar, Bokaro, Chandigarh, Chennai, Cuttack,
                Dehradun, Delhi-NCR, Gandhinagar, Guwahati, Haridwar, Hyderabad,
                Jaipur, Kochi, Kolkata, Lucknow, Ludhiana, Mumbai, Nagpur,
                Pathankot, Patna, Pune, Ranchi, Surat, Vijayawada &
                Visakhapatnam.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem className={styles.AccordianBtn}>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                The products available for you are based on your location. Once
                you enter your pincode on the Try at Home page, you can select
            ...
            <AccordionItem className={styles.AccordianBtn}>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                You can select up to 5 products for Try at Home. If you would
                like to select a few more designs to try, please contact us on
                1800-102-0103 (Toll Free), and we will help you with it.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem className={styles.AccordianBtn}>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                Our Try at Home consultant will visit your location to show you
                the designs, at a time and place that is convenient to you.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem className={styles.AccordianBtn}>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                Absolutely! You can request for the appointment to take place at
                your office, or any other indoor location.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem className={styles.AccordianBtn}>
              <h2>
                <AccordionButton>
                  <Box as="span" flex="1" textAlign="left">
                    What if the date or time slot convenient to me is not
                    available?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                In such cases, we request you to contact us on 1800-102-0103
                (Toll Free), and we will try to arrange the appointment as per
                your convenience.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem className={styles.AccordianBtn}>
              <h2>
                <AccordionButton>
                  <Box as="span" flex="1" textAlign="left">
                    After trying on the products at home, can I place the order
                    immediately?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                ...
                you can place an order on the spot with our Try at Home
                consultant.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem className={styles.AccordianBtn}>
              <h2>
                <AccordionButton>
                  <Box as="span" flex="1" textAlign="left">
                    Are all the jewellery sent for the Try at Home appointment
                    made of real gold?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                Yes, the jewellery we send to your home for trial is crafted
                with real gold and diamonds. If you place an order after the
                trial, you will receive the certificate of authenticity too.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem className={styles.AccordianBtn}>
              <h2>
                <AccordionButton>
                  <Box as="span" flex="1" textAlign="left">
                    What are the measures CaratLane is taking to ensure the Try
                    at Home consultants are healthy and safe?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              </h2>
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                ...
                - We monitor & record the temperature of all our consultants
                every day via thermal screening <br />- Every consultant uses
                the Aarogya Setu App to ensure they are healthy, and they have a
            ...
            <AccordionItem className={styles.AccordianBtn}>
              <h2>
                <AccordionButton>
                  <Box as="span" flex="1" textAlign="left">
                    What are the safety measures taken during the Try at Home
                    appointments?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              ...
              <AccordionPanel className={styles.AccordianPanel} pb={4}>
                - All our jewellery is sanitised with alcohol swabs before and
                after the appointment <br />
                - We sanitise our bag, jewellery kit, mirrors, ring sizer,
                bangle sizer, iPad, and everything else we bring, to ensure your
                safety <br />
                - For appointments in containment zones, we will first
                double-check with the customer if the entry is allowed and if
                it's a non-infected zone <br />
                - Proper social distancing during the appointment is practised,
                and we also bring a new mask for the customer to wear <br />
                <br />
                <br />
                Please note: We may need to check the status of the customer's
                health on the Aarogya Setu App.
              </AccordionPanel>
            </AccordionItem>
          </Accordion>
        </div>
